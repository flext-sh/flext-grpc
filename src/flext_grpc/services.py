...
class FlextGrpcServerService(FlextDomainService):
    ...
    def execute(self, operation: str, server: FlextGrpcServer, **options: Any) -> FlextResult[Any]:
    ...
    def _get_server_status(self, server: FlextGrpcServer) -> FlextResult[dict[str, Any]]:
...
class FlextGrpcClientService(FlextDomainService):
    ...
    def execute(self, operation: str, client: FlextGrpcClient, **options: Any) -> FlextResult[Any]:
    ...
    def _disconnect_client(self, client: FlextGrpcClient) -> FlextResult[FlextGrpcClient]:
    ...
    def _call_method(self, client: FlextGrpcClient, method_name: str | None, request_data: Any) -> FlextResult[dict[str, Any]]:
    ...
    def _get_client_status(self, client: FlextGrpcClient) -> FlextResult[dict[str, Any]]:
...
class FlextGrpcStreamService(FlextDomainService):
    ...
    def execute(self, operation: str, **options: Any) -> FlextResult[Any]:
    ...
    def _create_stream(self, client: FlextGrpcClient | None, method_name: str | None, stream_type: str) -> FlextResult[FlextGrpcStream]:
    ...
    def _send_data(self, stream: FlextGrpcStream | None, data: Any) -> FlextResult[bool]:
