...
def GrpcConfigurationError(*args: object, **kwargs: object) -> FlextGrpcConfigurationError:  # noqa: N802
...
def GrpcValidationErrorParams(*args: object, **kwargs: object) -> dict[str, object]:  # noqa: N802, ARG001
    ...
    _deprecation_warning("GrpcValidationErrorParams", "FlextGrpcValidationError context parameter")
    return {
...
def GrpcConfigurationErrorParams(*args: object, **kwargs: object) -> dict[str, object]:  # noqa: N802, ARG001
    ...
    _deprecation_warning("GrpcConfigurationErrorParams", "FlextGrpcConfigurationError context parameter")
    return {
...
def GrpcChannelErrorParams(*args: object, **kwargs: object) -> dict[str, object]:  # noqa: N802, ARG001
    ...
    _deprecation_warning("GrpcChannelErrorParams", "FlextGrpcChannelError context parameter")
    return {
