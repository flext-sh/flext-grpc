"""Basic usage examples for FLEXT gRPC library.

This example demonstrates the core functionality of the refactored
flext-grpc library with clean, simple API usage.
"""
...
def example_2_configuration():
    ...
    try:
        invalid_config = FlextGrpcConfig(host="", port=0)
...
def example_5_state_transitions():
