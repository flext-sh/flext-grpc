...
System_Boundary(flext_ecosystem, "FLEXT Ecosystem") {
    System(flext_core, "FLEXT-Core", "Foundation library with FlextCore.Result, FlextCore.Container, FlextCore.Service patterns")
...
Rel(flext_grpc, flext_core, "Depends on", "FlextCore.Result patterns, dependency injection")
