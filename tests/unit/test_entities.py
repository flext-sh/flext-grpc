...
class TestsFlextGrpcEntities:
    ...
    def test_channel_copy_with_overrides_target(self, channel: p.Grpc.Channel) -> None:
    ...
    def test_client_retains_attached_channel(self, channel: p.Grpc.Channel) -> None:
