...
class TestsFlextGrpcServices:
    ...
    def test_create_stream_defaults_are_applied(self, grpc_facade: FlextGrpc) -> None:
    ...
    def test_execute_returns_configured_settings(self, grpc_facade: FlextGrpc) -> None:
    ...
    def test_parse_address_splits_host_and_port(self, grpc_facade: FlextGrpc) -> None:
    ...
    def test_parse_address_fails_for_malformed_input(
        self, grpc_facade: FlextGrpc, address: str
    ) -> None:
