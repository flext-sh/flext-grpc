...
class TestDictToStruct:
    ...
    def test_dict_to_struct_none_data(self) -> None:
        ...
        result = dict_to_struct(None)  # type: ignore[arg-type]
    ...
    def test_dict_to_struct_conversion_failure(self) -> None:
        ...
        struct_pb2.Struct.update = mock_update  # type: ignore[method-assign,assignment]
        ...
        try:
            ...
            struct_pb2.Struct.update = original_update  # type: ignore[method-assign]
...
class TestStructToDict:
    ...
    def test_struct_to_dict_nested_struct(self) -> None:
        ...
        struct.update(nested_data)  # type: ignore[arg-type]
    ...
    def test_struct_to_dict_conversion_failure(self) -> None:
        ...
        result = struct_to_dict(invalid_struct)  # type: ignore[arg-type]
