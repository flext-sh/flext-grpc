"""Unit tests for real gRPC service operations.
...
class TestRealGrpcServices:
    ...
    def test_server_service_starts_real_grpc_server(self) -> None:
        ...
        server = FlextGrpcServer(
            id=FlextModels("test-real-server"),
            host="localhost",
